...
item = [
    #  values": [damage, acc, [str|dex], tier, attacks],["]" {'item': 'LONG KNIFE [', 'type': ']', 'values': [3, 60, [2, 5], 1, 1], 'cost': 42, 'grouping': False}
    ["]", {'item': 'LONG KNIFE [', 'type': ']', 'values': [3, 60, [2, 5], 1, 1], 'cost': 42, 'grouping': False}],
    ["]", {'item': '2 KNIFES [', 'type': ']', 'values': [2, 60, [3, 5], 1, 2], 'cost': 238, 'grouping': False}],
    ["]", {'item': 'SHORT DAGGER [', 'type': ']', 'values': [4, 75, [4, 6], 1, 1], 'cost': 911, 'grouping': False}],
    ["]", {'item': 'DAGGER [', 'type': ']', 'values': [5, 78, [5, 7], 1, 1], 'cost': 4398, 'grouping': False}],
    ["]", {'item': 'LONG DAGGER [', 'type': ']', 'values': [6, 80, [6, 8], 1, 1], 'cost': 15288, 'grouping': False}],

    ["]", {'item': 'CLUB [', 'type': ']', 'values': [7, 30, [4, 3], 1, 1], 'cost': 107, 'grouping': False}],
    ["]", {'item': 'WOODEN CLUB [', 'type': ']', 'values': [10, 33, [6, 4], 1, 1], 'cost': 1614, 'grouping': False}],
    ["]", {'item': 'MACE [', 'type': ']', 'values': [8, 30, [7, 5], 1, 2], 'cost': 15288, 'grouping': False}],
    ["]", {'item': 'FLAIL [', 'type': ']', 'values': [7, 30, [8, 6], 1, 3], 'cost': 78154, 'grouping': False}],

    ["]", {'item': 'SHOVEL [', 'type': ']', 'values': [3, 50, [4, 2], 1, 1], 'cost': 14, 'grouping': False}],
    ["]", {'item': 'SICKLE [', 'type': ']', 'values': [2, 70, [2, 4], 1, 1], 'cost': 9, 'grouping': False}],

    ["]", {'item': 'PUGINALE [', 'type': ']', 'values': [6, 40, [6, 2], 1, 1], 'cost': 238, 'grouping': False}],
    ["]", {'item': 'SPEAR [', 'type': ']', 'values': [11, 30, [7, 3], 1, 1], 'cost': 1614, 'grouping': False}],
    ["]", {'item': 'PIKE [', 'type': ']', 'values': [16, 30, [8, 4], 1, 1], 'cost': 15288, 'grouping': False}],
    ["]", {'item': 'HALBEARD [', 'type': ']', 'values': [22, 30, [9, 5], 1, 1], 'cost': 103317, 'grouping': False}],

    ["]", {'item': 'HAND AXE [', 'type': ']', 'values': [3, 60, [5, 2], 1, 1], 'cost': 42, 'grouping': False}],
    ["]", {'item': 'AXE [', 'type': ']', 'values': [5, 60, [6, 3], 2, 1], 'cost': 911, 'grouping': False}],
    ["]", {'item': 'HAEVY AXE [', 'type': ']', 'values': [8, 60, [7, 4], 3, 1], 'cost': 15288, 'grouping': False}],
    ["]", {'item': 'BROAD AXE [', 'type': ']', 'values': [10, 60, [8, 5], 4, 1], 'cost': 58320, 'grouping': False}],
    ["]", {'item': 'BATTLE AXE [', 'type': ']', 'values': [11, 60, [8, 5], 4, 1], 'cost': 103317, 'grouping': False}],

    ["]", {'item': 'SHORT SWORD [', 'type': ']', 'values': [8, 40, [6, 3], 1, 1], 'cost': 1342, 'grouping': False}],
    ["]", {'item': 'SWORD [', 'type': ']', 'values': [12, 40, [7, 4], 2, 1], 'cost': 15288, 'grouping': False}],
    ["]", {'item': 'LONG SWORD [', 'type': ']', 'values': [15, 40, [8, 5], 3, 1], 'cost': 58320, 'grouping': False}],
    ["]", {'item': 'GREAT SWORD [', 'type': ']', 'values': [16, 40, [9, 5], 4, 1], 'cost': 85899, 'grouping': False}],

    ["]", {'item': 'FOIL [', 'type': ']', 'values': [2, 60, [4, 4], 1, 2], 'cost': 238, 'grouping': False}],
    ["]", {'item': 'RAPIER [', 'type': ']', 'values': [2, 55, [5, 5], 1, 3], 'cost': 1614, 'grouping': False}],
    ["]", {'item': 'SABRE [', 'type': ']', 'values': [3, 50, [6, 6], 1, 3], 'cost': 10379, 'grouping': False}],
    ["]", {'item': 'KATANA [', 'type': ']', 'values': [7, 40, [7, 7], 2, 2], 'cost': 38551, 'grouping': False}],

    ["}", {'item': 'SHORT BOW {', 'type': '}', 'values': [3, 60, [2, 6], 1, 1], 'cost': 62, 'grouping': False}],
    ["}", {'item': 'BOW {', 'type': '}', 'values': [5, 60, [3, 7], 2, 1], 'cost': 931, 'grouping': False}],
    ["}", {'item': 'REFLEXIVE BOW {', 'type': '}', 'values': [8, 60, [4, 8], 3, 1], 'cost': 15308, 'grouping': False}],
    ["}", {'item': 'LONGBOW {', 'type': '}', 'values': [11, 60, [5, 9], 4, 1], 'cost': 103337, 'grouping': False}],
    ["}", {'item': 'HAND CROSBOW {', 'type': '}', 'values': [3, 40, [5, 3], 1, 1], 'cost': 23, 'grouping': False}],
    ["}", {'item': 'CROSBOW {', 'type': '}', 'values': [8, 40, [7, 7], 4, 1], 'cost': 1362, 'grouping': False}]
    ]
special_items = [
    ["!", {"item": "POTION OF HEALING", "type": "|", "values": [1, "POTIONS OF HEALING"], "cost": 19531, "grouping": True}],
    ["?", {"item": "SCROLL OF TELEPORT", "type": "|", "values": [1, "SCROLLS OF TELEPORT"], "cost": 19531, "grouping": True}],
...
def start_data():
    ...
    p = {
        ...
        "arrows_id": -1,
        "BP": [
            {"item": "POTION OF HEALING", "type": "|", "values": [1, "POTIONS OF HEALING"], "cost": 50, "grouping": True},
            {"item": "SCROLL OF TELEPORT", "type": "|", "values": [1, "SCROLLS OF TELEPORT"], "cost": 50, "grouping": True}
