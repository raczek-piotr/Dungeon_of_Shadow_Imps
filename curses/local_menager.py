...
item = [
    ...
    ["]", {"item": "KNIFE [", "type": "]", "values": [2, 60, 3, 1, 1], "cost": 10, "grouping": False}],
    ["]", {"item": "DAGGER [", "type": "]", "values": [3, 60, 4, 1, 1], "cost": 15, "grouping": False}],
    ["]", {"item": "PUGINALE [", "type": "]", "values": [4, 60, 5, 2, 1], "cost": 25, "grouping": False}],
    ["]", {"item": "SHORT SWORD [", "type": "]", "values": [6, 40, 5, 2, 1], "cost": 30, "grouping": False}],
    ["]", {"item": "SPEAR [", "type": "]", "values": [10, 40, 6, 3, 1], "cost": 40, "grouping": False}],
    ["]", {"item": "SWORD [", "type": "]", "values": [9, 50, 6, 3, 1], "cost": 45, "grouping": False}],
    ["]", {"item": "HAEVY SPEAR [", "type": "]", "values": [15, 40, 7, 4, 1], "cost": 60, "grouping": False}],

    ["*", {"item": "BREAD", "type": "", "values": [1, "BREADS"], "cost": 50, "grouping": True}],
    ["?", {"item": "POTION", "type": "", "values": [1, "POTIONS"], "cost": 50, "grouping": True}],

    ["}", {"item": "SLING {", "type": "}", "values": [2, 60, 4, 1, 2], "cost": 15, "grouping": False}],
    ["}", {"item": "SHORT BOW {", "type": "}", "values": [3, 60, 5, 1, 1], "cost": 20, "grouping": False}],
    ["}", {"item": "HAND CROSBOW {", "type": "}", "values": [4, 40, 5, 1, 1], "cost": 20, "grouping": False}],
    ["}", {"item": "BOW {", "type": "}", "values": [4, 60, 6, 2, 2], "cost": 30, "grouping": False}],
    ["}", {"item": "CROSBOW {", "type": "}", "values": [6, 40, 6, 2, 1], "cost": 30, "grouping": False}],
    ["}", {"item": "LONGBOW {", "type": "}", "values": [7, 60, 7, 3, 2], "cost": 45, "grouping": False}],
    ["}", {"item": "HEAVY CROSBOW {", "type": "}", "values": [11, 40, 7, 3, 1], "cost": 45, "grouping": False}]]
