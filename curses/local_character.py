...
def character(w, c, p):
    ...
    p = {
        ...
        "camp": [[["surface",0],[0,3],[0,3],[0,3],[0,3],[0,3],[0,3],[0,3],[0,3],[12,3],
                  ["fudit_village",2],[3,3],[3,3],[3,3],[3,3],[3,3],[3,3],[1,3],[1,3],[11,3],
                  ["stonehouse",1],[11,3],[1,3],[1,3],[1,3],[1,3],[1,3],[1,3],[1,3],[13,3],
...
def algal(w, c, p):
    ...
    w.addstr(11, 2, "3 - ALGAL MAGE", c.color_pair(7))
    w.refresh()
    while True:
        q = w.getkey()
        match q:
