...
def help(w, c, m, p): #not beautyful, but done -PR-
    ...
    w.addstr(2, 4, "@", c.color_pair(2))
    w.addstr(2, 12, "NPC", c.color_pair(2))
    w.addstr(2, 28, ". - light tile", c.color_pair(5))
    w.addstr(2, 54, "  - dark tile", c.color_pair(4))
    w.addstr(3, 2, "# - wall", c.color_pair(5))
    w.addstr(3, 28, "+ - closed door", c.color_pair(4))
    w.addstr(3, 54, ", - open door", c.color_pair(4))
    w.addstr(4, 2, "> - stairs down", c.color_pair(1))
    ...
    w.addstr(6, 2, '% - tree/forest', c.color_pair(2))
    w.addstr(6, 28, '= - water/river/lake', c.color_pair(6))
    w.addstr(6, 54, '& - lava', c.color_pair(7))

    w.addstr(8, 0, "Game items:", c.color_pair(4))
    w.addstr(9, 2, "] - melee weapon", c.color_pair(2))
    w.addstr(9, 28, "} - ranged weapon", c.color_pair(2))
    ...
    w.addstr(11, 2, "- +1 dex and +1 str", c.color_pair(1))
    w.addstr(12, 2, "- +1 int if you play non classic DoSI", c.color_pair(1))
