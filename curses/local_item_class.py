...
from local_spells import fire_compendium
...
['*', [['MOLD', 0, 300], '*', 1, False, 5]], #4
['*', [['BREAD', 0, 900], '*', 1, False, 15]], #5
['*', [['RATION OF FOOD', 0, 1500], '*', 1, False, 25]], #6
['~', [['TORCH', 1, 1200], '~', 1, False, 19]], #7
...
[']', [['HAND AXE', 'e_attack'], ']', [2, 3, 1, 70, 11, 8], True, 467]], #39
...
[']', [['HALBERD', 'e_attack'], ']', [4, 10, 1, 35, 14, 10], True, 2360]], #49
...
['}', [['COMPOSITE BOW', 'e_hand', 'ARROW'], '}', [1, 15, 1, 70, 9, 13], True, 1417]], #54
...
['?', [['FIRE COMPENDIUM', 'e_hand', False], '{', fire_compendium, True, 5000]], #65
